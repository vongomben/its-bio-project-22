...
Ultrasonic ultrasonic1(BCM10);
Ultrasonic ultrasonic2(BCM9);
Ultrasonic ultrasonic3(BCM11);
...
void loop() {
  ...
  RangeInCentimeters3 = ultrasonic3.MeasureInCentimeters(); // two measurements should keep an interval

  if (RangeInCentimeters1 < 10) {
  ...
  Serial.print(" - ");
  Serial.print(RangeInCentimeters3);//0~400cm
  Serial.println();
  delay(25);
}
